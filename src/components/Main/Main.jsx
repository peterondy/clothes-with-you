...
const Main = () => {
    return (
        <main className='h-screen w-full video-background'>
            <video autoPlay loop muted poster="poster.jpg" className='z-[-999]'>
                <source src={background} type="video/mp4" />
            </video>
            <h2 className='text-[#8f8f80] text-3xl pt-8 z-50'>enter into the complex styling world with AI technology</h2>
